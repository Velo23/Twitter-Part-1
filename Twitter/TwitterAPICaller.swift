...
class TwitterAPICaller: BDBOAuth1SessionManager {
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "sv0lEYZpvzxlge8DRI5WGSY7b", consumerSecret: "2QiroruuC6DmqDVC1nHoA6eXnEvlVXEgVcqfyQpgRykMmkPgr8")
    var loginSuccess: (() -> ())?
